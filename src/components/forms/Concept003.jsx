...
export default function Concept003() {
  return (
    <div className="min-h-screen flex items-center justify-center px-3 sm:px-4 py-10 bg-gradient-to-br from-[#0f2027] via-[#203a43] to-[#2c5364] font-['Inter',sans-serif]">
      <div className="w-full max-w-md bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl px-5 sm:px-8 py-8 shadow-2xl text-white">
        <div className="text-center mb-6">
          <h1 className="text-2xl sm:text-3xl font-bold mb-1 tracking-wide">Welcome Back</h1>
        ...
        <form className="space-y-6">
          <div>
            ...
            <div className="flex items-center border border-white/20 rounded-lg bg-white/5 backdrop-blur px-3 py-2 focus-within:ring-2 focus-within:ring-[#FFD369] transition">
              ...
              <input
                ...
                className="bg-transparent w-full text-white placeholder-gray-400 focus:outline-none text-sm"
              />
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between text-xs text-gray-300 gap-2">
